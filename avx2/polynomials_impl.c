...
extern inline poly512_vec poly512_load_dup(const void* s);
...
extern inline void poly512_store1(void* d, poly512_vec s);
...
extern inline poly576_vec poly576_from_512(poly512_vec x);
extern inline poly1024_vec poly1024_from_512(poly512_vec x);
...
extern inline poly576_vec poly576_add(poly576_vec x, poly576_vec y);
extern inline poly1024_vec poly1024_add(poly1024_vec x, poly1024_vec y);
...
extern inline poly1024_vec poly512_mul(poly512_vec x, poly512_vec y);
...
extern inline poly576_vec poly64x512_mul(poly64_vec x, poly512_vec y);
...
extern inline poly384_vec poly1x384_mul(poly1_vec x, poly384_vec y);
extern inline poly512_vec poly1x512_mul(poly1_vec x, poly512_vec y);
extern inline poly1024_vec poly1x1024_mul(poly1_vec x, poly1024_vec y);
...
extern inline poly1024_vec poly1024_shift_left_1(poly1024_vec x);
...
extern inline poly1024_vec poly1024_shift_left_8(poly1024_vec x);
...
extern inline poly512_vec poly512_set_zero();
...
extern inline poly512_vec poly1024_reduce512(poly1024_vec x);
...
extern inline poly512_vec poly576_reduce512(poly576_vec x);
...
extern inline poly512_vec poly512_from_1(poly1_vec x);
extern inline poly128_vec poly128_from_128_poly1(const poly1_vec* bits);
extern inline poly128_vec poly128_from_16_poly1(const poly1_vec* bits);
extern inline poly128_vec poly128_from_8_poly1(const poly1_vec* bits);
extern inline poly192_vec poly192_from_192_poly1(const poly1_vec* bits);
extern inline poly192_vec poly192_from_16_poly1(const poly1_vec* bits);
extern inline poly192_vec poly192_from_8_poly1(const poly1_vec* bits);
extern inline poly256_vec poly256_from_256_poly1(const poly1_vec* bits);
extern inline poly256_vec poly256_from_16_poly1(const poly1_vec* bits);
extern inline poly256_vec poly256_from_8_poly1(const poly1_vec* bits);
extern inline poly512_vec poly512_from_512_poly1(const poly1_vec* bits);
extern inline poly512_vec poly512_from_16_poly1(const poly1_vec* bits);
extern inline poly512_vec poly512_from_8_poly1(const poly1_vec* bits);
extern inline poly128_vec poly128_from_128_poly128(const poly128_vec* polys);
extern inline poly128_vec poly128_from_16_poly128(const poly128_vec* polys);
extern inline poly128_vec poly128_from_8_poly128(const poly128_vec* polys);
extern inline poly192_vec poly192_from_192_poly192(const poly192_vec* polys);
extern inline poly192_vec poly192_from_16_poly192(const poly192_vec* polys);
extern inline poly192_vec poly192_from_8_poly192(const poly192_vec* polys);
extern inline poly256_vec poly256_from_256_poly256(const poly256_vec* polys);
extern inline poly256_vec poly256_from_16_poly256(const poly256_vec* polys);
extern inline poly256_vec poly256_from_8_poly256(const poly256_vec* polys);
extern inline poly512_vec poly512_from_512_poly512(const poly512_vec* polys);
extern inline poly512_vec poly512_from_16_poly512(const poly512_vec* polys);
extern inline poly512_vec poly512_from_8_poly512(const poly512_vec* polys);
extern inline poly128_vec poly128_from_8_poly64(const poly64_vec* polys);
extern inline poly192_vec poly192_from_8_poly64(const poly64_vec* polys);
extern inline poly256_vec poly256_from_8_poly64(const poly64_vec* polys);
extern inline poly512_vec poly512_from_8_poly64(const poly64_vec* polys);
...
extern inline poly512_vec poly512_from_byte(uint8_t byte);
...
extern inline bool poly576_eq(poly576_vec x, poly576_vec y);
extern inline bool poly1024_eq(poly1024_vec x, poly1024_vec y);
...
extern inline poly1024_vec poly1024_extract(poly1024_vec x, size_t index);
